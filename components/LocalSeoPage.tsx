      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500">
              Kein Kalkulator nötig – füllen Sie direkt das Formular aus. Bei automatisch
              berechenbaren Anfragen erhalten Sie Ihre Offerte in der Regel innerhalb von 2 Minuten.
            </p>
          </div>
